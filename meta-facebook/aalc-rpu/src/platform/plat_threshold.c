...
uint8_t fan_pump_sensor_array[] = { 
	...
	// pump
	SENSOR_NUM_PB_1_PUMP_TACH_RPM, SENSOR_NUM_PB_2_PUMP_TACH_RPM, 
...
void fan_board_tach_status_handler(uint8_t sensor_num, uint8_t status)
{
	...
	{	
		//LOG_WRN("fan THRESHOLD_STATUS_LCR");
	...
	{	
		//LOG_WRN("fan THRESHOLD_STATUS_NORMAL");
	...
	{	
		//LOG_WRN("fan DEVICE_NOT_PRESENT");
		WRITE_BIT(pwrgd_read_back_val, 0, 0);
...
void pump_board_tach_status_handler (uint8_t sensor_num, uint8_t status)
{
	...
	LOG_WRN("pump gok value: %ld",read_pump_gok & BIT(2));
...
sensor_threshold threshold_tbl[] = {
	...
	{ SENSOR_NUM_FB_1_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 2000, 0, hex_fan_failure_do, SENSOR_NUM_FB_1_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_2_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_2_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_3_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_3_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_4_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_4_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_5_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_5_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_6_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_6_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_7_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_7_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_8_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_8_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_9_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_9_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_10_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_10_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_11_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_11_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_12_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_12_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_13_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_13_FAN_TACH_RPM },
	{ SENSOR_NUM_FB_14_FAN_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, hex_fan_failure_do, SENSOR_NUM_FB_14_FAN_TACH_RPM },
	{ SENSOR_NUM_PB_1_PUMP_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, pump_failure_do, SENSOR_NUM_PB_1_PUMP_TACH_RPM },
	{ SENSOR_NUM_PB_2_PUMP_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, pump_failure_do, SENSOR_NUM_PB_2_PUMP_TACH_RPM },
	{ SENSOR_NUM_PB_3_PUMP_TACH_RPM, THRESHOLD_ENABLE_LCR, 1000, 0, pump_failure_do, SENSOR_NUM_PB_3_PUMP_TACH_RPM },
	...
	{ SENSOR_NUM_PB_3_FAN_1_TACH_RPM, THRESHOLD_ENABLE_LCR, 5000, 0,
	  rpu_internal_fan_failure_do, SENSOR_NUM_PB_3_FAN_1_TACH_RPM },
	{ SENSOR_NUM_PB_3_FAN_2_TACH_RPM, THRESHOLD_ENABLE_LCR, 5000, 0,
...
void threshold_poll_handler(void *arug0, void *arug1, void *arug2)
{
	...
	while (1) {
		...
		for (uint8_t i = 0; i < ARRAY_SIZE(threshold_tbl); i++) {
			...
			// to determine if tach value is 164, set status to DEVICE_NOT_EXIST status 
			if (val == 164.0){
				threshold_tbl[i].last_status = DEVICE_NOT_PRESENT;
				continue;
			}
...
void fan_pump_pwrgd_handler(void *arug0, void *arug1, void *arug2)
{
	...
	while (1) {
		for (uint8_t i = 0; i < ARRAY_SIZE(fan_pump_sensor_array); i++) {
			...
			uint8_t read_gok = nct7363_read_back_data(cfg, NCT7363_GPIO0x_INPUT_PORT_REG_OFFSET);
			if (read_gok == READ_ERROR)
				LOG_ERR("Read pump_board_pwrgd gpio fail, read_back_val: %d", read_gok);
			
			uint8_t pwrgd_read_back_val = nct7363_read_back_data(cfg, NCT7363_GPIO1x_OUTPUT_PORT_REG_OFFSET);
			if (pwrgd_read_back_val == READ_ERROR)
