...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_BPB_RACK_LEVEL_3, sensor_dev_nct7363, I2C_BUS5, BPB_NCT7363_ADDR,
	  NCT7363_GPIO_READ_OFFSET, evt_access, NCT7363_7_PORT, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &nct7363_init_args[17] },
	...
	for (uint8_t i = 0; i < SIZEOF_NCT7363_INIT_ARGS; i++) {
		...
		/*
			...
			Modify :
				...
				fault_fan from port11 to port8
			Add :
				tach2 in port16
		*/ 
		if (i < 14) 
		{
			...
			f->gpio_04 = 1; //gpio out default value (active low)
			...
			// pwm pin type
			f->pin_type[NCT7363_8_PORT] = NCT7363_PIN_TPYE_PWM;
			// pwm setting
			f->fan_frequency[NCT7363_8_PORT] = 2; 
			f->duty[NCT7363_8_PORT] = 0; 
		}
		/*
		...
		*/ 
		...
		{
			LOG_ERR("change_dvt_sensor_config error");
			return;
		}
	}
