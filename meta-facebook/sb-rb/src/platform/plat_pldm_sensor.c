...
uint8_t check_sensor_type(uint8_t sensor_num)
{
	...
	if (sensor_num <= SENSOR_NUM_ASIC_HAMSA_CRM_LS_TEMP_C)
		return TEMP_SENSOR_THREAD_ID;
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_C,
			.type = sensor_dev_tmp431,
			.port = I2C_BUS3,
			.target_addr = ASIC_MEDHA0_SENSOR0_SENSOR1_ADDR,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_OWL_W_OWL_E_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_OWL_W_OWL_E_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_OWL_W_OWL_E_TEMP_C,
			.type = sensor_dev_tmp431,
			.port = I2C_BUS3,
			.target_addr = ASIC_OWL_W_OWL_E_ADDR,
			.offset = TMP431_LOCAL_TEMPERATRUE,
			.access_checker = is_temp_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			ASIC_MEDHA1_SENSOR0_SENSOR1_ADDR, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			ASIC_MEDHA1_SENSOR0_SENSOR1_ADDR, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_MEDHA1_SENSOR0_SENSOR1_TEMP_C,
			.type = sensor_dev_tmp431,
			.port = I2C_BUS2,
			.target_addr = ASIC_MEDHA1_SENSOR0_SENSOR1_ADDR,
			.offset = TMP431_LOCAL_TEMPERATRUE,
			.access_checker = is_temp_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_HAMSA_CRM_LS_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_HAMSA_CRM_LS_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_HAMSA_CRM_LS_TEMP_C,
			.type = sensor_dev_tmp431,
			.port = I2C_BUS2,
			.target_addr = ASIC_HAMSA_CRM_LS_ADDR,
			.offset = TMP431_LOCAL_TEMPERATRUE,
			.access_checker = is_temp_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
...
PDR_sensor_auxiliary_names plat_pdr_sensor_aux_names_table[] = {
	...
	},
	{
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_OWL_W_OWL_E_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_OWL_W_OWL_E_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_MEDHA1_SENSOR0_SENSOR1_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA1_SENSOR0_SENSOR1_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_HAMSA_CRM_LS_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_HAMSA_CRM_LS_TEMP_C",
	},
};
