...
temp_threshold_mapping_sensor temp_index_threshold_type_table[] = {
	...
	{ ASIC_MEDHA0_SENSOR0_SENSOR1_LOW_LIMIT, LOCAL_LOW_LIMIT,
	  SENSOR_NUM_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_C,
	  "SB_RB_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_LOW_LIM" },
	{ ASIC_MEDHA0_SENSOR0_SENSOR1_HIGH_LIMIT, LOCAL_HIGH_LIMIT,
	  SENSOR_NUM_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_C,
	  "SB_RB_ASIC_MEDHA0_SENSOR0_SENSOR1_TEMP_HIGH_LIM" },
	{ ASIC_OWL_W_OWL_E_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_OWL_W_OWL_E_TEMP_C,
	  "SB_RB_ASIC_OWL_W_OWL_E_TEMP_LOW_LIM" },
	{ ASIC_OWL_W_OWL_E_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_OWL_W_OWL_E_TEMP_C,
	  "SB_RB_ASIC_OWL_W_OWL_E_TEMP_HIGH_LIM" },
	{ ASIC_MEDHA1_SENSOR0_SENSOR1_LOW_LIMIT, LOCAL_LOW_LIMIT,
	  SENSOR_NUM_ASIC_MEDHA1_SENSOR0_SENSOR1_TEMP_C,
	  "SB_RB_ASIC_MEDHA1_SENSOR0_SENSOR1_TEMP_LOW_LIM" },
	{ ASIC_MEDHA1_SENSOR0_SENSOR1_HIGH_LIMIT, LOCAL_HIGH_LIMIT,
	  SENSOR_NUM_ASIC_MEDHA1_SENSOR0_SENSOR1_TEMP_C,
	  "SB_RB_ASIC_MEDHA1_SENSOR0_SENSOR1_TEMP_HIGH_LIM" },
	{ ASIC_HAMSA_CRM_LS_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_HAMSA_CRM_LS_TEMP_C,
	  "SB_RB_ASIC_HAMSA_CRM_LS_TEMP_LOW_LIM" },
	{ ASIC_HAMSA_CRM_LS_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_HAMSA_CRM_LS_TEMP_C,
	  "SB_RB_ASIC_HAMSA_CRM_LS_TEMP_HIGH_LIM" },
};
...
bool temp_threshold_default_settings_init(void)
{
	for (int i = 0; i < PLAT_TEMP_INDEX_THRESHOLD_TYPE_MAX; i++) {
		...
		if (i == ASIC_MEDHA0_SENSOR0_HIGH_LIMIT || i == ASIC_MEDHA0_SENSOR1_HIGH_LIMIT ||
		    ...
		    i == ASIC_MEDHA0_SENSOR0_SENSOR1_HIGH_LIMIT ||
		    i == ASIC_OWL_W_OWL_E_HIGH_LIMIT ||
		    i == ASIC_MEDHA1_SENSOR0_SENSOR1_HIGH_LIMIT ||
		    i == ASIC_HAMSA_CRM_LS_HIGH_LIMIT) {
			temperature = 100000;
		}
