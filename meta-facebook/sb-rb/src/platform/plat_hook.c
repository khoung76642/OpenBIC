...
vr_mapping_sensor vr_rail_table[] = {
	...
	*/
	{ VR_RAIL_E_ASIC_P0V85_MEDHA0_VDD, SENSOR_NUM_ASIC_P0V85_MEDHA0_VDD_VOLT_V,
	  "ASIC_P0V85_MEDHA0_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V85_MEDHA0_VDD_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V85_MEDHA1_VDD, SENSOR_NUM_ASIC_P0V85_MEDHA1_VDD_VOLT_V,
	  "ASIC_P0V85_MEDHA1_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V85_MEDHA1_VDD_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V9_OWL_E_TRVDD, SENSOR_NUM_ASIC_P0V9_OWL_E_TRVDD_VOLT_V,
	  "ASIC_P0V9_OWL_E_TRVDD", 0xffffffff, SENSOR_NUM_ASIC_P0V9_OWL_E_TRVDD_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_TRVDD, SENSOR_NUM_ASIC_P0V75_OWL_E_TRVDD_VOLT_V,
	  "ASIC_P0V75_OWL_E_TRVDD", 0xffffffff, SENSOR_NUM_ASIC_P0V75_OWL_E_TRVDD_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_MAX_M_VDD, SENSOR_NUM_ASIC_P0V75_MAX_M_VDD_VOLT_V,
	  "ASIC_P0V75_MAX_M_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V75_MAX_M_VDD_CURR_A, 0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM1357, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM1357_VOLT_V,
	  "ASIC_P0V75_VDDPHY_HBM1357", 0xffffffff, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM1357_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_VDD, SENSOR_NUM_ASIC_P0V75_OWL_E_VDD_VOLT_V,
	  "ASIC_P0V75_OWL_E_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V75_OWL_E_VDD_CURR_A, 0xffffffff },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM1357_VOLT_V,
	  "ASIC_P0V4_VDDQL_HBM1357", 0xffffffff, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM1357_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM1357, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM1357_VOLT_V,
	  "ASIC_P1V1_VDDQC_HBM1357", 0xffffffff, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM1357_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM1357, SENSOR_NUM_ASIC_P1V8_VPP_HBM1357_VOLT_V,
	  "ASIC_P1V8_VPP_HBM1357", 0xffffffff, SENSOR_NUM_ASIC_P1V8_VPP_HBM1357_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_MAX_N_VDD, SENSOR_NUM_ASIC_P0V75_MAX_N_VDD_VOLT_V,
	  "ASIC_P0V75_MAX_N_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V75_MAX_N_VDD_CURR_A, 0xffffffff },
	{ VR_RAIL_E_ASIC_P0V8_HAMSA_AVDD_PCIE, SENSOR_NUM_ASIC_P0V8_HAMSA_AVDD_PCIE_VOLT_V,
	  "ASIC_P0V8_HAMSA_AVDD_PCIE", 0xffffffff, SENSOR_NUM_ASIC_P0V8_HAMSA_AVDD_PCIE_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE, SENSOR_NUM_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE_VOLT_V,
	  ...
	  SENSOR_NUM_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE_CURR_A, 0xffffffff },
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, SENSOR_NUM_ASIC_P0V85_HAMSA_VDD_VOLT_V,
	  "ASIC_P0V85_HAMSA_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V85_HAMSA_VDD_CURR_A, 0xffffffff },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM0246, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM0246_VOLT_V,
	  "ASIC_P1V1_VDDQC_HBM0246", 0xffffffff, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM0246_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM0246, SENSOR_NUM_ASIC_P1V8_VPP_HBM0246_VOLT_V,
	  "ASIC_P1V8_VPP_HBM0246", 0xffffffff, SENSOR_NUM_ASIC_P1V8_VPP_HBM0246_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM0246_VOLT_V,
	  "ASIC_P0V4_VDDQL_HBM0246", 0xffffffff, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM0246_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM0246_VOLT_V,
	  "ASIC_P0V75_VDDPHY_HBM0246", 0xffffffff, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM0246_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, SENSOR_NUM_ASIC_P0V75_OWL_W_VDD_VOLT_V,
	  "ASIC_P0V75_OWL_W_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V75_OWL_W_VDD_CURR_A, 0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, SENSOR_NUM_ASIC_P0V75_MAX_S_VDD_VOLT_V,
	  "ASIC_P0V75_MAX_S_VDD", 0xffffffff, SENSOR_NUM_ASIC_P0V75_MAX_S_VDD_CURR_A, 0xffffffff },
	{ VR_RAIL_E_ASIC_P0V9_OWL_W_TRVDD, SENSOR_NUM_ASIC_P0V9_OWL_W_TRVDD_VOLT_V,
	  "ASIC_P0V9_OWL_W_TRVDD", 0xffffffff, SENSOR_NUM_ASIC_P0V9_OWL_W_TRVDD_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_TRVDD, SENSOR_NUM_ASIC_P0V75_OWL_W_TRVDD_VOLT_V,
	  "ASIC_P0V75_OWL_W_TRVDD", 0xffffffff, SENSOR_NUM_ASIC_P0V75_OWL_W_TRVDD_CURR_A,
	  0xffffffff },
	{ VR_RAIL_E_P3V3_OSFP_VOLT_V, SENSOR_NUM_P3V3_OSFP_VOLT_V, "P3V3_OSFP_VOLT_V", 0xffffffff,
	  SENSOR_NUM_P3V3_OSFP_CURR_A, 0xffffffff },
};
...
bool vr_rail_iout_value_get(uint8_t rail, int *iout_value)
{
	CHECK_NULL_ARG_WITH_RETURN(iout_value, false);
	...
	*iout_value = vr_rail_table[rail].iout_value;
