...
const vr_test_mode_setting_t vr_test_mode_table[] = {
	...
	{ VR_RAIL_E_ASIC_P0V85_MEDHA0_VDD, 14300, 14300, 200, 1095, 913, 595, 930, 0 },
	{ VR_RAIL_E_ASIC_P0V85_MEDHA1_VDD, 14300, 14300, 200, 1095, 913, 595, 930, 0 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_E_TRVDD, 170, 170, 200, 1112, 927, 630, 1120, 0 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_TRVDD, 110, 110, 200, 927, 773, 525, 975, 0 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_M_VDD, 1200, 1200, 200, 963, 803, 525, 975, 0 },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM1357, 1500, 1500, 200, 946, 788, 525, 930, 0 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_VDD, 1600, 1600, 200, 945, 788, 525, 930, 0 },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, 530, 530, 200, 538, 448, 280, 520, 0 },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM1357, 3200, 3200, 200, 1439, 1199, 770, 1310, 0 },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM1357, 140, 140, 200, 2358, 1965, 1260, 1970, 0 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_N_VDD, 670, 670, 200, 981, 818, 525, 975, 0 },
	{ VR_RAIL_E_ASIC_P0V8_HAMSA_AVDD_PCIE, 500, 500, 200, 1044, 870, 560, 1040, 0 },
	{ VR_RAIL_E_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE, 100, 100, 200, 1542, 1285, 840, 1310, 0 },
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, 1000, 1000, 200, 1089, 908, 595, 1053, 0 },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM0246, 3200, 3200, 200, 1439, 1199, 770, 1310, 0 },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM0246, 140, 140, 200, 2358, 1965, 1260, 1970, 0 },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, 530, 530, 200, 536, 447, 280, 520, 0 },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, 1500, 1500, 200, 950, 792, 525, 930, 0 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, 1600, 1500, 200, 951, 793, 525, 930, 0 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, 660, 660, 200, 975, 813, 525, 975, 0 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_W_TRVDD, 170, 170, 200, 1112, 927, 630, 1120, 0 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_TRVDD, 110, 110, 200, 927, 773, 525, 975, 0 },
};
...
const mps_vr_test_mode_setting_t vr_mps_test_mode_table[] = {
	...
	*/
	...
	{ VR_RAIL_E_ASIC_P0V85_MEDHA1_VDD, 1424, NO_USE, 500, 595, 930, NO_USE, NO_USE, NO_ACTION,
	  923, NO_USE, 880 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_E_TRVDD, 17, 0, 400, 630, 1120, NO_USE, NO_USE, NO_ACTION, 927,
	  NO_USE, 900, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_TRVDD, 11, 0, 400, 525, 975, NO_USE, NO_USE, NO_ACTION, 778,
	  NO_USE, 755, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_M_VDD, 120, 0, 400, 525, 975, NO_USE, NO_USE, NO_ACTION, 813,
	  NO_USE, 775, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM1357, 138, 0, 400, 525, 930, NO_USE, NO_USE, NO_ACTION,
	  808, NO_USE, 770, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_VDD, 159, 0, 400, 525, 930, NO_USE, NO_USE, NO_ACTION, 808,
	  NO_USE, 770, NO_USE },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, 53, 0, 400, 280, 520, NO_USE, NO_USE, NO_ACTION, 445,
	  NO_USE, 405, NO_USE },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM1357, 318, 0, 400, 770, 1310, NO_USE, NO_USE, NO_ACTION,
	  1192, NO_USE, 1115, NO_USE },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM1357, 14, 0, 400, 1260, 1970, NO_USE, NO_USE, NO_ACTION, 1970,
	  NO_USE, 1820, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_N_VDD, 67, 0, 400, 525, 975, NO_USE, NO_USE, NO_ACTION, 808,
	  NO_USE, 770, NO_USE },
	{ VR_RAIL_E_ASIC_P0V8_HAMSA_AVDD_PCIE, 50, 0, 400, 560, 1040, NO_USE, NO_USE, NO_ACTION,
	  850, NO_USE, 810, NO_USE },
	{ VR_RAIL_E_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE, 10, 0, 400, 840, 1310, NO_USE, NO_USE, NO_ACTION,
	  1260, NO_USE, 1200, NO_USE },
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, 100, 0, 400, 595, 1053, NO_USE, NO_USE, NO_ACTION, 918,
	  NO_USE, 875, NO_USE },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM0246, 318, 0, 400, 770, 1310, NO_USE, NO_USE, NO_ACTION,
	  1192, NO_USE, 1115, NO_USE },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM0246, 14, 0, 400, 1260, 1970, NO_USE, NO_USE, NO_ACTION, 1970,
	  NO_USE, 1820, NO_USE },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, 53, 0, 400, 280, 520, NO_USE, NO_USE, NO_ACTION, 445,
	  NO_USE, 405, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, 138, 0, 400, 525, 930, NO_USE, NO_USE, NO_ACTION,
	  808, NO_USE, 770, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, 159, 0, 400, 525, 930, NO_USE, NO_USE, NO_ACTION, 803,
	  NO_USE, 765, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, 66, 0, 400, 525, 975, NO_USE, NO_USE, NO_ACTION, 788,
	  NO_USE, 750, NO_USE },
	{ VR_RAIL_E_ASIC_P0V9_OWL_W_TRVDD, 17, 0, 400, 630, 1120, NO_USE, NO_USE, NO_ACTION, 927,
	  NO_USE, 900, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_TRVDD, 11, 0, 400, 525, 975, NO_USE, NO_USE, NO_ACTION, 778,
	  NO_USE, 755, NO_USE },
};
