...
compnt_mapping_sensor vr_compnt_mapping_sensor_table[] = {
	...
	{ COMPNT_VR_5, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM1357_TEMP_C, "ASIC_P0V4_VDDQL_HBM1357" },
	...
	{ COMPNT_VPD_HAMSA_VDD, SENSOR_NUM_ASIC_P0V85_HAMSA_VDD_TEMP_C, "ASIC_P0V85_HAMSA_VDD" },
	{ COMPNT_VPD_OWL_E_VDD, SENSOR_NUM_ASIC_P0V75_OWL_E_VDD_TEMP_C, "ASIC_P0V75_OWL_E_VDD" },
};
static uint8_t pldm_pre_bic_update(void *fw_update_param)
{
