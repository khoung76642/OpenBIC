...
temp_mapping_sensor temp_index_table[] = {
	...
	{ TEMP_INDEX_ASIC_MEDHA0_VPD, SENSOR_NUM_ASIC_MEDHA0_VPD_TEMP_C,
	  "SB_RB_ASIC_MEDHA0_VPD_TEMP" },
	{ TEMP_INDEX_ASIC_MEDHA1_VPD, SENSOR_NUM_ASIC_MEDHA1_VPD_TEMP_C,
	  "SB_RB_ASIC_MEDHA1_VPD_TEMP" },
};
...
temp_threshold_mapping_sensor temp_index_threshold_type_table[] = {
	...
	{ ASIC_MEDHA0_VPD_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA0_VPD_TEMP_C,
	  "SB_RB_ASIC_MEDHA0_VPD_TEMP_LOW_LIM" },
	{ ASIC_MEDHA0_VPD_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA0_VPD_TEMP_C,
	  "SB_RB_ASIC_MEDHA0_VPD_TEMP_HIGH_LIM" },
	{ ASIC_MEDHA1_VPD_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA1_VPD_TEMP_C,
	  "SB_RB_ASIC_MEDHA1_VPD_TEMP_LOW_LIM" },
	{ ASIC_MEDHA1_VPD_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA1_VPD_TEMP_C,
	  "SB_RB_ASIC_MEDHA1_VPD_TEMP_HIGH_LIM" },
};
...
bool temp_threshold_default_settings_init(void)
{
	for (int i = 0; i < PLAT_TEMP_INDEX_THRESHOLD_TYPE_MAX; i++) {
		...
		if (i == ASIC_MEDHA0_SENSOR0_HIGH_LIMIT || i == ASIC_MEDHA0_SENSOR1_HIGH_LIMIT ||
		    ...
		    i == ASIC_MEDHA0_VPD_HIGH_LIMIT || i == ASIC_MEDHA1_VPD_HIGH_LIMIT) {
			temperature = 100000;
		}
