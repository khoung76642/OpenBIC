...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_BPB_RPU_COOLANT_FLOW_RATE_LPM, sensor_dev_ads112c, I2C_BUS5,
	  ...
	  NULL, NULL, NULL, NULL, &ads112c_init_args[5] },
...
const int SENSOR_CONFIG_SIZE = ARRAY_SIZE(plat_sensor_config) + ARRAY_SIZE(hsc_sensor_config_table);
